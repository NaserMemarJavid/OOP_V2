	...
	public void schreibeFreizeitbaederInDatei(String typ){
		try{
			if("csv".equals(typ)){
				...
				this.freizeitbaederView.zeigeInformationsfensterAn("Die Daten wurde in csv Datei geschpeichert.");
				...
				this.freizeitbaederView.zeigeInformationsfensterAn("Die Daten wurde in txt Datei geschpeichert.");
